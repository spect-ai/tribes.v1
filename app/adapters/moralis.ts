...
export function updateTask(Moralis: any, task: any, status: string, columnId: string) {
  console.log(task);
  const params = {
    task: task,
    status: status,
...
export function updateBoard(Moralis: any, boardId: string, name: string, columns: any, statusList: string[]) {
  const params = {
    boardId: boardId,
    name: name,
    columns: columns,
