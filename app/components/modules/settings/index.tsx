    ...
    return (
        <MainContainer>
            <SettingTabContainer>
                ...
                <TabItems>
                    <TabItem onClick={()=>setTabNo(1)} style={tabNo == 1 ? {backgroundColor: '#313247', borderRadius: '10px', padding: '0px 12px'} : {}}>Profile</TabItem>
                    <TabItem onClick={()=>setTabNo(2)} style={tabNo == 2 ? {backgroundColor: '#313247', borderRadius: '10px', padding: '0px 12px'} : {}}>Contributors</TabItem>
                </TabItems>
            </SettingTabContainer>
            {
                tabNo == 1 
                    ...
                    <Header>Organise Profile</Header>
                        <form onSubmit={handleSubmit(onSubmit)}>
                            <SettingsBlock>
                                <Setting>
                                    <FormItem>
                                        <FormLabel id="demo-row-radio-buttons-group-label" style={{fontSize: '11px', color:'#91909D', textTransform: 'uppercase', fontWeight: 'bold'}}>Name</FormLabel>
                                        <Controller
                                            name="name"
                                            control={control}
                                    ...
                                    <FormItem>
                                        <FormLabel id="demo-row-radio-buttons-group-label" style={{fontSize: '11px', color:'#91909D', textTransform: 'uppercase', fontWeight: 'bold'}}>Tagline</FormLabel>
                                        <Controller
                                            name="tagline"
                                            control={control}
                                            defaultValue=''
                                    ...
                                    <FormItem>
                                        <FormLabel id="demo-row-radio-buttons-group-label" style={{fontSize: '11px', color:'#91909D', textTransform: 'uppercase', fontWeight: 'bold'}}>Description</FormLabel>
                                        <Controller
                                            name="description"
                                            control={control}
                                            defaultValue=''
                                    ...
                                    <FormItem>
                                        <FormLabel id="demo-row-radio-buttons-group-label" style={{fontSize: '11px', color:'#91909D', textTransform: 'uppercase', fontWeight: 'bold'}}>Tags</FormLabel>
                                        <Controller
                                            name="tags"
                                            control={control}
                                            defaultValue=''
                                    ...
                                    <FormItem>
                                        <FormLabel id="demo-row-radio-buttons-group-label" style={{fontSize: '11px', color:'#91909D', textTransform: 'uppercase', fontWeight: 'bold'}}>Socials</FormLabel>
